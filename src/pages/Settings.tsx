...
import { Trophy, Upload, X, Camera, User, LogOut } from "lucide-react";
            ...
            <div className="flex items-center justify-between mb-10">
              ...
              <div className="flex space-x-3">
                ...
                <button
                  ...
                  className="chess-btn-outline px-4 py-2 flex items-center space-x-2 text-chess-mahogany border-chess-mahogany hover:bg-chess-mahogany hover:text-white"
                >
